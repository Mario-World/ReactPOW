...
const CurrencyConverter = () => {
    ...
    //Currencies => https://api.frankfurter.app/curriencies
    ...
    useEffect(() => {   //this hook will allows you to update after component renders, 
        fetchCurrencies();  // It handles side effects like data fetching.
    },[]);
